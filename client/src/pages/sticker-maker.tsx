  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <header className="bg-white/95 backdrop-blur-md border-b border-slate-200/60 px-6 py-3.5 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto flex items-center justify-between relative" style={{ minHeight: '28px' }}>
          ...
          <div className="flex-1 flex justify-end">
            <span className="text-xs text-slate-400 font-medium">Last Update April 18, 2026</span>
          </div>
        </div>
      </header>
